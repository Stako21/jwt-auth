...
export async function getDocumentsService(user, query) {
  ...
  const sql = `
    SELECT
      ...
      td.request_agent_name AS tro_request_agent_name,
      td.request_agent_login AS tro_request_agent_login,
      td.request_route_name AS tro_request_route_name,
      td.request_assortment_name AS tro_request_assortment_name,
