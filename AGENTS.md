...
- TRO workflow, assigned-TA access, accounting completion rules, and numbering in `api/services/TroDocumentService.js`; changing an existing UP document number or removing it must return a TRO document to `NOT_COMPLETED`.
